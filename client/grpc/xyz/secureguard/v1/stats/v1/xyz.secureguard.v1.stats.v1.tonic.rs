...
pub mod stats_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn today(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("xyz.secureguard.v1.stats.v1.StatsService", "Today"),
                );
        ...
        pub async fn by_date(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("xyz.secureguard.v1.stats.v1.StatsService", "ByDate"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn total(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("xyz.secureguard.v1.stats.v1.StatsService", "Total"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod stats_service_server {
    ...
    pub const SERVICE_NAME: &str = "xyz.secureguard.v1.stats.v1.StatsService";
